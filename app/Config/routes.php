 ...
 */
	...
	//Router::connect('/principios', array('controller' => 'pages', 'action' => 'display', 'principios'));
	//Router::connect('/praticas', array('controller' => 'pages', 'action' => 'display', 'praticas'));
	//Router::connect('praticas/pratica1', array('controller' => 'pages', 'action' => 'display', 'pratica1'));
